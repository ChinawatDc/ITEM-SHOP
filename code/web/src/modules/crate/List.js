  ...
  render() {
    return (
      <div>
        {/* SEO */}
        <Helmet>
          <title>Groups for everyone! - Crate</title>
        </Helmet>

        {/* Top title bar */}
        <Grid style={{ backgroundColor: grey }}>
          <GridCell style={{ padding: '2em', textAlign: 'center' }}>
            <H3 font="secondary">Grates for everyone!</H3>

            <p style={{ marginTop: '1em', color: grey2 }}>You can choose a group that best suits your needs. You can also subscribe to multiple groups.</p>
          </GridCell>
        </Grid>
